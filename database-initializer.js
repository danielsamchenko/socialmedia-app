...
mc.connect("mongodb://127.0.0.1:27017/", { useNewUrlParser: true }, function(err, client) {
	...
	db.collection("gallery").insertMany(arts, function(err,result){
		if(err) throw err;
	  client.close();
	});
